...
class CurrentProjectUI {
    ...
    private void deleteTask(){
        ...
        if(!currentProject.removeTask(currentProject.getTaskById(taskId))) System.out.println("Invalid id");
        //currentProject.removeTask(currentProject.getTaskById(id));
    }
    ...
    private void updateTask() {
        ...
        if (task != null) {
            ...
            System.out.print("New state (T)odo (D)one? or change Priority (P)rio ");
            ...
            if (stateChar == 'T') {
                ...
                System.out.println("Prio? (L)ow, (M)edium, (H)igh");
                char priority = InputUtils.scanAndReturnFirstChar(scan);
                if(priority == 'L'){
